...
<section class="history">
    <div class="container">
        <div class="history-titel col-lg-12 text-center pt-4">
            <h2>Our History</h2>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptate, doloribus officia. Temporibus, id excepturi! Impedit.</p>
        </div>
        <div class="row gx-3 p-4">
            <div class="col-xl-5 m-4 image-sec">
                <img class="col-lg-12" style="max-width:100%; max-height:100%" src="assets/image/about/about-1.jpg" alt="history">
            </div>
            <div class="col-xl-5 m-4 content-sec">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aspernatur fugit dicta recusandae natus similique, repudiandae adipisci dolores dolorem voluptatem nobis labore blanditiis consequuntur cupiditate porro quasi consequatur, et ratione cumque iure eum, est ea modi itaque quod? Iste, neque quo nemo expedita rerum quisquam vitae. Provident quis obcaecati distinctio voluptatem.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="mission">
    <div class="container">
        <div class="row gx-3 p-4">
            ...
            <div class="col-xl-5 m-4 image-sec">
                <img class="col-lg-12" style="max-width:100%; max-height:100%" src="assets/image/about/about-2.jpg" alt="mission">
            </div>
        </div>
    </div>
</section>
...
<section class="vission">
    <div class="container">
        <div class="row gx-3 p-4">
            <div class="col-xl-5 m-4 image-sec">
                <img class="col-lg-12" style="max-width:100%; max-height:100%" src="assets/image/about/about-3.jpg" alt="vission">
            </div>
            <div class="col-xl-5 m-4 content-sec">
                <h2>Our Vission</h2>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aspernatur fugit dicta recusandae natus similique, repudiandae adipisci dolores dolorem voluptatem nobis labore blanditiis consequuntur cupiditate porro quasi consequatur, et ratione cumque iure eum, est ea modi itaque quod? Iste, neque quo nemo expedita rerum quisquam vitae. Provident quis obcaecati distinctio voluptatem.</p>
