...
<section class="breadcumb-area">
    <div class="container text-center pt-4">
        <div class="row">
            <div class="col-xl-12">
                <div class="breadcumb">
                    <h2>Services 3 columns</h2>
                    <ul class="d-flex list-unstyled" >
                        <li>Home</li> /
                        <li>services-3-columns</li>
                    </ul>
                </div>
            </div>
        </div>
...
<!-- breadcumb area end -->
<!-- service section -->
<section class="service-3 mt-4" id="service-3">
  <div class="container ">
    <div class="row">
        <div class="col-xl-4 p-3 service-single">
            <a href="{{ route('single-service') }}">
