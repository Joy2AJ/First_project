...
<!-- header area end -->
<!-- service section -->
<section class="single-service-page mt-2" id="single-service-page">
  <div>
    <div class="row">
        <div class="col breadcumb carousel p-4">
          <img class="col-lg-12 d-block w-100 bc-img"  style=" max-height:70%; " src="assets/image/service/service-1.jpg" alt="service">
